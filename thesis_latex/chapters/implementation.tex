...
\valign{#\cr
    \hbox{%
    \begin{subcodefigure}{.4\textwidth}
    \centering
     \begin{minted}[fontsize=\footnotesize]{rust}
let (x, y, z):(A, B, C) = actual_fun();
     \end{minted}
    \end{subcodefigure}%
  }
  \cr
